...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
        ...
        // const BadFlashLoanReceiverFactory = await ethers.getContractFactory('FlashLoanReceiver', attacker); 
        // this.badReceiver = await BadFlashLoanReceiverFactory.deploy(this.pool.address);
        for (let i=0; i<10; i++) {
